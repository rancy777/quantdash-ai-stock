...
import { getSectorDataFreshness, getSectorRotationData, getSectorPersistenceData } from '../services/sectorService';
import { DataFreshnessMeta, SectorBoardType, SectorCycleData, SectorPersistenceData } from '../types';
...
const SectorCycleSection: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
        ...
        setDataFreshness(getSectorDataFreshness(boardType));
        setLoading(false);
    };
    loadData();
  }, [boardType]);
